...
def reproj_with_shifted(pcds_xyzi, shifted_pcds, Voxel, dx, dy, phi_range_radian, theta_range_radian, dphi, dtheta):
    '''
    Input:
        pcds_xyzi (BS, 7, N, 1), 7 -> (x, y, z, intensity, dist, diff_x, diff_y) NOT USED ATM
        pcds_offset (BS, N, 3)
    Output:
        pcds_coord_wl_reproj, pcds_sphere_coord_reproj (BS, N, 2, 1)
    '''
